...
export class WasmPacket {
  free(): void;
  constructor(kind: PacketKind, message_id: string | null | undefined, user_id: string | null | undefined, reaction_kind: ReactionKind | null | undefined, payload: Uint8Array);
  serialized(): boolean;
...
export interface InitOutput {
  ...
  readonly wasmpacket_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: any) => number;
