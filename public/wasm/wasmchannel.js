...
export const PacketKind = Object.freeze({
    Message: 0, "0": "Message",
    OnlineUsers: 1, "1": "OnlineUsers",
    Delete: 2, "2": "Delete",
    Reaction: 3, "3": "Reaction",
    Joined: 4, "4": "Joined",
    Typing: 5, "5": "Typing",
});
/**
...
const WasmPacketFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmpacket_free(ptr >>> 0, 1));
...
export class WasmPacket {
    ...
    constructor(kind, message_id, user_id, reaction_kind, payload) {
        var ptr0 = isLikeNone(message_id) ? 0 : passStringToWasm0(message_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(user_id) ? 0 : passStringToWasm0(user_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpacket_new(kind, ptr0, len0, ptr1, len1, isLikeNone(reaction_kind) ? 5 : reaction_kind, payload);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasmchannel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
